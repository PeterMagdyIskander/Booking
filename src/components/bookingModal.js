...
const BookingModal = (props) => {
  ...
  if (authedUser) {
    reservationBlueprint["userName"] = authedUser.firstName;
    reservationBlueprint["phoneNumber"] = authedUser.phoneNumber;
  }
  const handleBooking = () => {
  ...
  return (
    ...
    >
      ...
      <input
        placeholder="please enter the number of campers"
        onChange={handleChangeNumberOfCampers}
      />

      <p>age Range </p>
      <input
        placeholder="please enter the age range of campers"
      ...
      <div>
        <select value={place} onChange={handlePlaceChange}>
          <option
            value="please select a section to book"
        ...
        <input
          placeholder="please enter the number of rooms that u need"
